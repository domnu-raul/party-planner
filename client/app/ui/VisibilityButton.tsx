...
const VisibilityButton: React.FC<VisibilityButtonProps> = ({ isVisible, onToggle, id }) => {
  return (
    <div className="absolute right-3 top-1/2 transform -translate-y-1/2">
      <input
        ...
        onChange={onToggle}
      />
      <label htmlFor={`${id}-visibility`} className="cursor-pointer">
        {isVisible ? (
          <svg
            ...
            width="32px"
            className="fill-slate-900 opacity-60 hover:opacity-90"
          >
